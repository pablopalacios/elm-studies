...
var _user$project$Select$results = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['results']),
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string));
var _user$project$Select$Fail = function (a) {
	return {ctor: 'Fail', _0: a};
};
var _user$project$Select$Success = function (a) {
	return {ctor: 'Success', _0: a};
};
var _user$project$Select$search = function (term) {
	var url = A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:5000/search?term=', term);
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Select$Fail,
		_user$project$Select$Success,
		A2(_evancz$elm_http$Http$get, _user$project$Select$results, url));
};
var _user$project$Select$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Search':
				var _p1 = _p0._0;
				var length = _elm_lang$core$String$length(_p1);
				return _elm_lang$core$Native_Utils.eq(length, 0) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_List.fromArray(
						[]),
					_1: _elm_lang$core$Platform_Cmd$none
				} : ((_elm_lang$core$Native_Utils.cmp(length, 3) > -1) ? {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Select$search(_p1)
...
var _user$project$Select$Search = function (a) {
	return {ctor: 'Search', _0: a};
};
var _user$project$Select$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onInput(_user$project$Select$Search)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				A2(
					...
					function (result) {
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text(result)
								]));
					},
					model))
			]));
};
var _user$project$Select$main = {
	main: _elm_lang$html$Html_App$program(
		{
			...
			update: _user$project$Select$update,
			subscriptions: function (model) {
				return _elm_lang$core$Platform_Sub$none;
			},
			view: _user$project$Select$view
		})
};

var Elm = {};
Elm['Select'] = Elm['Select'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Select'], 'Select', typeof _user$project$Select$main === 'undefined' ? null : _user$project$Select$main);
